$(document).ready(function () {
    ...
    $.getJSON("../../../controller/admin_kevin/listeIngredient.php").done(function (result) {   // Requete AJAX - Récupérer tous les ingrédients
    ...
    $("#bouttonAjouterPizza").click(function () {
        ...
        $.ajax({
            url: "../../../controller/admin_kevin/ajouterDataPizza.php",
            type: "POST",
            data: {
                piz: pizza,
                ingr: ingr,
            ...
            success: function (result) {
                console.log(result);
                document.location.href = "../../../view/pages/page_admin/IHM_ADMIN.html";
            },
            error: function (err) {
                console.log(err);
                document.location.href = "../../../view/pages/page_admin/IHM_ADMIN.html";
